...
public class CreateNewCategoryDialog extends CustomDialog {
    ...
    private VBox createDialogContentBox() {
        ...
        newCategoryTextField.setPromptText(
                "Enter Category Name");

        newCategoryTextField.getStyleClass().addAll(
                "text-size-md",
                "field-background",
                "text-light-gray");
        ...
        colorPicker.getStyleClass().add(
                "text-size-md");

        colorPicker.setMaxWidth(
                Double.MAX_VALUE);

        createCategoryBtn = new Button("Create");

        createCategoryBtn.getStyleClass().addAll(
                "bg-light-blue",
                "text-size-md",
                "text-white");

        createCategoryBtn.setMaxWidth(
                Double.MAX_VALUE);

        createCategoryBtn.setOnMouseClicked(
                new EventHandler<MouseEvent>() {
                    ...
                    public void handle(MouseEvent mouseEvent) {
                        ...
                        String color = Utilitie.getHexColorValue(
                                colorPicker);
                        ...
                        boolean postTransactionCategoryStatus = SqlUtil.postTransactionCategory(
