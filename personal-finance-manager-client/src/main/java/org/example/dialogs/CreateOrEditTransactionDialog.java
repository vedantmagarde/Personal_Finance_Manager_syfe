...
public class CreateOrEditTransactionDialog extends CustomDialog {
    ...
    public CreateOrEditTransactionDialog(
    ...
    private VBox createMainContentBox() {
        ...
        transactionNameField.setPromptText(
                "Enter Transaction Name");

        transactionNameField.getStyleClass().addAll(
                "field-background",
                "text-light-gray",
                "text-size-md",
                "rounded-border");
        ...
        transactionAmountField.setPromptText(
                "Enter Transaction Amount");

        transactionAmountField.getStyleClass().addAll(
                "field-background",
                "text-light-gray",
                "text-size-md",
                "rounded-border");
        ...
        transactionDatePicker.setPromptText(
                "Enter Transaction Date");

        transactionDatePicker.getStyleClass().addAll(
                "field-background",
                "text-light-gray",
                "text-size-md",
                "rounded-border");

        transactionDatePicker.setMaxWidth(
                Double.MAX_VALUE);

        transactionCategoryBox = new ComboBox<>();

        transactionCategoryBox.setPromptText(
                "Choose Category");

        transactionCategoryBox.getStyleClass().addAll(
                "field-background",
                "text-light-gray",
                "text-size-md",
                "rounded-border");

        transactionCategoryBox.setMaxWidth(
                Double.MAX_VALUE);
    ...
    private HBox createTransactionTypeRadioButtonGroup() {
        ...
        incomeRadioButton.setToggleGroup(
                transactionTypeToggleGroup);

        incomeRadioButton.getStyleClass().addAll(
                "text-size-md",
                "text-light-gray");

        RadioButton expenseRadioButton = new RadioButton("Expense");

        expenseRadioButton.setToggleGroup(
                transactionTypeToggleGroup);

        expenseRadioButton.getStyleClass().addAll(
                "text-size-md",
                "text-light-gray");
        ...
        radioButtonsBox.getChildren().addAll(
                incomeRadioButton,
                expenseRadioButton);
    ...
    private HBox createConfirmAndCancelButtonsBox() {
                ...
                new EventHandler<MouseEvent>() {
                    ...
                    public void handle(MouseEvent mouseEvent) {
                        ...
                        if (isEditing) {
                            ...
                            transactionDataObject.addProperty(
                                    "id",
                        ...
                        String transactionType = ((RadioButton) transactionTypeToggleGroup
                        ...
                        if (transactionCategoryName != null) {
                            ...
                            if (transactionCategory != null) {
                                ...
                                transactionCategoryData.addProperty(
                                        "id",
                                        transactionCategory.getId());

                                transactionDataObject.add(
                                        "transactionCategory",
                        ...
                        boolean status = !isEditing
                                ? SqlUtil.postTransaction(
                                        transactionDataObject)
                                : SqlUtil.putTransaction(
                                        transactionDataObject);
                        ...
                        if (status) {
                            ...
                            if (isEditing) {
                                ...
                                transactionComponent
                                        ...
                                        .setText(
                                                transactionCategoryName.isEmpty()
                                                        ? "Undefined"
                                                        : transactionCategoryName);

                                transactionComponent
                                        .getTransactionNameLabel()
                                        .setText(transactionName);
        ...
        confirmAndCancelBox.getChildren().addAll(
                saveButton,
                cancelButton);
